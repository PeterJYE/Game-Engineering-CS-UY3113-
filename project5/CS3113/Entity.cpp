...
Entity::Entity() : mPosition {0.0f, 0.0f}, mMovement {0.0f, 0.0f}, 
                   ...
                   mCurrentTexture {0}, mTextureType {SINGLE}, mAngle {0.0f},
...
Entity::Entity(Vector2 position, Vector2 scale, const char *textureFilepath, 
    ...
    mColliderDimensions {scale}, mRenderOffset {0.0f, 0.0f},
...
void Entity::render()
{
    ...
    Rectangle destinationArea = {
        mPosition.x + mRenderOffset.x,
        mPosition.y + mRenderOffset.y,
