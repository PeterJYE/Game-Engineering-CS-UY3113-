...
void Map::render()
{
    ...
    for (int row = 0; row < mMapRows; row++)
    {
        ...
        for (int col = 0; col < mMapColumns; col++)
        {
            ...
            // Tile 1 is a normal platform and tile 9 is a trap platform
            // until gameplay logic removes it from the level data.
            if (tile != 1 && tile != 9) continue;
